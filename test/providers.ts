...
const feederApiProvider = new FeederApiProvider(network)
const comboApiProvider = new ComboApiProvider(pathfinderUrl, network)

const apiProvider: ApiProvider = comboApiProvider
...
describe('providers', function() {
  ...
  describe('DatabaseAbiProvider', async function() {
    ...
    it('organizeConstructorFunction for proxy contract 0x1b1748e401b692796ac064782e821a93ee0b1f7db2db4262d2ddbd3c8d66508', async () => {
      ...
      const getTransactionResponse = await apiProvider.getTransaction(txHash) as any
      const blockNumber = 269717
      log(getTransactionResponse)

      const transactionCallOrganizer = new TransactionCallOrganizer(databaseAbiProvider)

      const organizedFunction = await transactionCallOrganizer.organizeInvokeFunction(getTransactionResponse, blockNumber)
    ...
    it( 'organizeBlock problem blocks', async function () {
      const blocks = [322717/*269717/*269354/*269147/*269130/*268515/*268486/*268464/*68385/*268374/*254923/*235506/*231612/*231579/*167434/*183423/*190290/*161308/*164233/*62135/*111570/*38172/*36568/*27592/*17281/*71368/*71405/*200501/*1564/*1064/*86*/]
  ...
  describe('ApiProvider', async function() {
    ...
    it('getBlock', async () => {
      ...
      const rp = await pathfinderApiProvider.getBlock(blockNumber)
      log(rp)
      ...
      const rf = await feederApiProvider.getBlock(blockNumber)
      log(rf)
    })
    ...
    it('getContractAbi 0x6715e129c11f1c5ec5ea460115de61e7d21f9e6873cb27109bc0bb3339acf53', async () => {
      ...
      expect(pathfinderApiProvider.getContractAbi(contractAddress)).to.throw
    ...
    it('getContractAbi', async () => {
      ...
      const rc = await apiProvider.getContractAbi(contractAddress)
    ...
    it('getClassAbi', async () => {
      ...
      const rf = await feederApiProvider.getClassAbi(classHash)
      log(rf)
      ...
      expect(pathfinderApiProvider.getClassAbi(classHash)).to.throw

      const rc = await apiProvider.getClassAbi(classHash)
    ...
    it('callView', async () => {
      ...
      let rp = await pathfinderApiProvider.callView(contractAddressProxy, 'get_implementation', blockNumber)
      log(rp)
      expect(rp).deep.eq([
        "0x70a61892f03b34f88894f0fb9bb4ae0c63a53f5042f79997862d1dffb8d6a30"
      ])

      let rf = await feederApiProvider.callView(contractAddressProxy, 'get_implementation', blockNumber)
      log(rf)
      expect(rp).deep.eq(rf)

      rp = await pathfinderApiProvider.callView(contractAddressProxy, 'get_implementation') // latest
      log(rp)
      expect(rp).deep.eq([
        "0x70a61892f03b34f88894f0fb9bb4ae0c63a53f5042f79997862d1dffb8d6a30"
      ])
      ...
      rp = await pathfinderApiProvider.callView(contractAddressProxy, 'get_implementation', blockNumber)
      log(rp)
      expect(rp).deep.eq([
      ...
      expect(pathfinderApiProvider.callView(contractAddressProxy, 'get_implementation', blockNumber)).to.throw
    })

    it('getTransactionReceipt', async () => {
      const txHash = '0x103cc13a763b9191165e469aa2a0fbd5b0e8a1ff05dad44f50c397bc56b70a8'

      const rc = await apiProvider.getTransactionReceipt(txHash)
      log(rc)
      ...
      const rf = await feederApiProvider.getTransactionReceipt(txHash)
      log(rf)
    ...
    it('getTransaction INVOKE', async () => {
      ...
      const rc = await apiProvider.getTransaction(txHash)
      log(rc)
      ...
      const rf = await feederApiProvider.getTransaction(txHash)
      log(rf)
