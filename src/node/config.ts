...
let conf: {
  ...
  STARKNET_API_TIMEOUT: number
  STARKNET_API_CALL_RETRIES: number
...
export function configure(): void {
  ...
  conf = {
    ...cleanEnv(process.env, {
      ...
      DEBUG: str({ default: 'starknet-indexer:*,index-builder:*' }),
      VERBOSE: bool({
        default: false,
      ...
      NEW_BLOCK_TIMEOUT_MS: num({
        default: 60 * 10 * 1000,
        desc: `If the block producer does not receive a new block within this time limit,
