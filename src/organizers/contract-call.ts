...
export class ContractCallOrganizer {
  ...
  constructor(readonly contractAddress: string, readonly blockNumber: number, private readonly apiProvider: ApiProvider, private readonly blockHash?: string, private structs?: OrganizedStructAbi, private functions?: OrganizedFunctionAbi, private events?: OrganizedEventAbi, private constructorFunction?: FunctionAbi) {}

  async initialize() {
    const abi = await this.apiProvider.getContractAbi(this.contractAddress, this.blockNumber, this.blockHash)
